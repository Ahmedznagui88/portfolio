...
<div class="row">
    <div class="col-md-12 contain-img">
        <a href="/"><p class="bn30">home</p></a>
        <a href="{{ route('about') }}"><p class="bn31">about</p></a>
        <a href="{{ route('expertise') }}"><p class="bn31">expertise</p></a>
        <a href="/"><p class="bn32">work</p></a>
        <a href="{{ route("contact") }}"><p class="bn33">contact</p></a>
